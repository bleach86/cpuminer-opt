...
} alliumV2_4way_ctx_holder;

static __thread alliumV2_4way_ctx_holder alliumV2_4way_ctx;

bool init_alliumV2_4way_ctx()
{
   keccak256_4way_init( &alliumV2_4way_ctx.keccak );
   cubehashInit( &alliumV2_4way_ctx.cube, 256, 16, 32 );
   skein256_4way_init( &alliumV2_4way_ctx.skein );
   init_groestl256( &alliumV2_4way_ctx.groestl, 32 );
   return true;
}
...
void alliumV2_4way_hash( void *state, const void *input )
{
   ...
   alliumV2_4way_ctx_holder ctx __attribute__ ((aligned (64))); 

   memcpy( &ctx, &alliumV2_4way_ctx, sizeof(alliumV2_4way_ctx) );
   ...
   memcpy( &ctx.groestl, &alliumV2_4way_ctx.groestl,
                             ...
                             uint64_t *hashes_done )
{
   ...
   blake256_4way_init( &alliumV2_4way_ctx.blake );
   blake256_4way( &alliumV2_4way_ctx.blake, vdata, 64 );
